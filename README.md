...
| [`ko/`](cpp/data/ko/README.md) | [open-dict-data/ipa-dict](https://github.com/open-dict-data/ipa-dict); optional morph ONNX: [KoichiYasuoka/roberta-base-korean-morph-upos](https://huggingface.co/KoichiYasuoka/roberta-base-korean-morph-upos) | [→](cpp/data/ko/README.md) |
